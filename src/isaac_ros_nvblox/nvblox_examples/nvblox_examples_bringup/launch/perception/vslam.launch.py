...
def add_vslam(args: lu.ArgumentContainer) -> List[Action]:
    ...
    base_parameters = {
        ...
        'gyro_noise_density': 0.00017839469755056068,
        'gyro_random_walk': 0.000012533329346733335,
        'accel_noise_density': 0.0013636728479572298,
        'accel_random_walk': 0.0001857520186076679,
